...
namespace Bank
{
    public partial class Certificates : Form
    {
        ...
        private void CreateColumns()
        {
            ...
            dataGridView1.Columns.Add("N_nositel", "№ Носителя");
            dataGridView1.Columns.Add("N_sticker", "№ Наклейки");
            dataGridView1.Columns.Add("N_sertif", "Серийный номер сертификата");
        ...
        {
            dgw.Rows.Add(record.GetInt32(0), record.GetInt32(1), record.GetString(2), record.GetString(3), record.GetInt32(4), record.GetInt32(5), record.GetInt32(6), record.GetDateTime(7), record.GetDateTime(8), RowState.ModifiedNew);
        ...
        private void Opdate()
        {
            for (int index = 0; index < dataGridView1.Rows.Count; index++)
            {
                ...
                if (rowState == RowState.Modified)
                {
                    ...
                    var changeQuery = $"update Certificates set INN = '{INN}', N_nositel = '{Nnositel}', N_sticker = '{Nsticker}', N_certif = '{Nsertif}',nach = '{nach.Month}/{nach.Day}/{nach.Year}', kon = '{kon.Month}/{kon.Day}/{kon.Year}' where id = '{id}'";
        ...
        private void button_insert_Click(object sender, EventArgs e)
        {
            ...
            var addQuery = $"insert into Certificates (INN, N_nositel, N_sticker, N_certif, nach, kon) values ('{INN}', '{Nnositel}', '{Nsticker}', '{Nsertif}', '{nach.Month}/{nach.Day}/{nach.Year}', '{kon.Month}/{kon.Day}/{kon.Year}')";
